...
export const TextField: React.FC<TextFieldProps> = ({
    ...
    return (
        <div className={`mb-4 ${className || ''}`}>
            ...
            <input
                type={type}
                className={`w-full px-3 py-2.5 bg-input border border-border-default rounded-md text-primary text-xl transition-all outline-none focus:border-border-focus focus:ring-2 focus:ring-primary-10 ${error ? '!border-error' : ''}`}
                value={value}
    ...
    return (
        <div className={`mb-4 ${className || ''}`}>
            ...
            <div className="flex items-center gap-3">
                ...
                <input
                    type="number"
                    className={`w-full px-3 py-2.5 bg-input border border-border-default rounded-md text-primary text-xl transition-all outline-none focus:border-border-focus focus:ring-2 focus:ring-primary-10 w-[80px] text-center ${error ? '!border-error' : ''}`}
                    value={value}
                    onChange={(e) => {
    ...
    return (
        <div className={`mb-4 flex items-center justify-between p-3 bg-surface rounded-lg ${className || ''}`}>
            <div className="flex-1">
                <label className="block text-lg font-medium text-primary mb-0">{label}</label>
...
export const FormSection: React.FC<FormSectionProps> = ({
    ...
    return (
        <div className={`mb-5 p-4 bg-elevated rounded-xl ${collapsed ? '' : ''}`}>
            ...
            >
                <div className="">
                    <h4 className="m-0 text-xl font-semibold text-primary">{title}</h4>
