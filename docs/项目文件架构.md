...
> 基于 **React + Vite + TypeScript** + **Tailwind CSS**，采用分层架构设计。
> **最后更新**: 2026-01-02 (服务模块重构后)
...
| 目录 | 状态 | 用途 |
|------|------|------|
| `services/database/` | ✅ 可用 | Dexie IndexedDB 数据库 |
| `services/rag/` | 🔲 占位 | 未来 Graph RAG 检索 |
